defmodule AdventOfCode2021 do
  ...
  alias AdventOfCode2021.Day8
  alias AdventOfCode2021.Day9
  ...
  def day8_part1(),
    do: read_parse_and_execute(:day8, &Day8.parse_input/1, &Day8.part_1/1)

  def day8_part2(),
    do: read_parse_and_execute(:day8, &Day8.parse_input/1, &Day8.part_2/1)

  def day9_part1(),
    do: read_parse_and_execute(:day9, &Day9.parse_input/1, &Day9.part_1/1)

  def day9_part2(),
    do: read_parse_and_execute(:day9, &Day9.parse_input/1, &Day9.part_2/1)

  def day10_part1(),
    do: read_parse_and_execute(:day10, &Day10.parse_input/1, &Day10.part_1/1)

  def day10_part2(),
    do: read_parse_and_execute(:day10, &Day10.parse_input/1, &Day10.part_2/1)

  def day11_part1(),
    do: read_parse_and_execute(:day11, &Day11.parse_input/1, &Day11.part_1/1)

  def day11_part2(),
    do: read_parse_and_execute(:day11, &Day11.parse_input/1, &Day11.part_2/1)
